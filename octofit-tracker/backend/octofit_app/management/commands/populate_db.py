...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        self.stdout.write('Debug: Command populate_db is being executed.')
        ...
        # Corrigir a adição de membros diretamente à lista
        for team in teams:
            team.members = users  # Adiciona os usuários diretamente à lista
            team.save()
